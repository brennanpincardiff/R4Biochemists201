...
download.file(url=link1, destfile="file.fcs", mode="wb")
...
download.file(url=link2, destfile="file.fcs", mode="wb")
data2 <- flowCore::read.FCS("file.fcs", alter.names = TRUE)
p2 <- plot_cfse(data2)
...
download.file(url=link3, destfile="file.fcs", mode="wb")
data3 <- flowCore::read.FCS("file.fcs", alter.names = TRUE)
p3 <- plot_cfse(data3)
