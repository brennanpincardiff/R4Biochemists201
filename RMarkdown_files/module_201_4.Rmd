...
The teaching materials in this module are designed to take approximately 60
minutes to work through. The exercises may take quite a bit longer as the
material is getting more complex. Please be patient with yourself.
Take breaks as you need. Completing all of this in a single sitting is probably
not wise. The material provided includes text to read, video demonstrations,
...
* Document a function
* A little about Version Control and Git
* Exploring packages 
...
functions or can be a detailed programming or calculations.
...
For instructions on how to install the package go the the
[Bioconductor](https://www.bioconductor.org/packages/release/bioc/html/drawProteins.html) home page.
Use drawProteins to generate a
schematic of your favourite protein. Maybe add this code to the RMarkdown
file that you created earlier in the course. Remember you can show some or
