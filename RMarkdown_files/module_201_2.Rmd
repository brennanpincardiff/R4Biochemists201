---
title: "R for Biochemists 201 Module 2 - A multipanel figure with p-values"
...
### Welcome to the second R for Biochemists 201 Training module.

Each module is designed to take approximately 60 minutes to complete. 

The material provided includes text to read, video demonstrations, 
example R scripts with exercises. We hope you enjoy the modules. 
...
* Doing a little statistical analsyis with R
* Adding statistics to plots with ggpubr
* Preparing multipanel figures with R
...
### The Experiment
I would like to continue with the data from the  Nature publication by 
Croft et al. In figure 4a, the authors have draw 12 bar plots, 
calculated some statistics and labelled the plots. In this module, I would 
like to reproduce this data. 
...
So if you look at the data... it's a bit of a challenge. There is lots of missing
...
If you look at the file in Excel, you notice that the names are offset by a line.
You can also see that the first six values are one set, there is a gap and the 
...
There is a video of the Excel clean up below. 
A cleaned up file to import into R is available.
Then you have the R script to create Tidy data.
...
* Try out a script from the R for Biochemists website <>
