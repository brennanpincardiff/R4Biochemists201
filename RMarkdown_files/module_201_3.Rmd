...
script with exercises. We hope you enjoy the modules. We welcome feedback and
comments. 
...
#### Bold and italic
Using the asterix give *text in bold* using underscore _gives text in italics_
...
### Code block options
##### Fourth video - options for code blocks... 
Three key options:
...
* We have explored the options for code blocks:
    + showing and running the code
    + hiding and running the code to generate output
    + showing code but not running (evaluating) 
